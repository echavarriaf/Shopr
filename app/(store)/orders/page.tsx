        ...
        {orders.length === 0 ? (
          ...
          <div className="space-y-6 sm:space-y-8">
            {orders.map((order, idx: number) => (
              ...
              //         <p className="text-sm text-gray-600 mb-1">Order Data</p>
              ...
              //         <span
              //           className={`px-3 py-1 rounded-fulltext-sm ${order.status === "paid" ? "bg-green-100 text-green-800" : "bg-gray-100 text-gray-800"}`}
              //         >
              ...
              //         <div
              //           key={idx}
              //           className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 py-2 borderb last:border-b-0"
              //         >
